...
mod tests {
    ...
    fn send_ack_msg<D: Debug + PartialEq + Serialize + DeserializeOwned>(
        ...
        let mut channel = BufWriter::new(Vec::with_capacity(1_000));
        sender_msl.write_ack_msg(custom_data.as_ref(), &mut channel)?;
    ...
    fn send_user_msg<D: Debug + PartialEq + Serialize + DeserializeOwned>(
        ...
        let mut channel = BufWriter::new(Vec::with_capacity(1_000));
        sender_msl.write(&data, &mut channel)?;
    ...
    fn test_ordered_passing_case<D: Clone + Debug + PartialEq + Serialize + DeserializeOwned>(
        ...
        connect_msg_custom_data: Option<D>,
        ack_msg_custom_data: Option<D>,
        user_msg_data: Option<D>,
    ) -> Result<()> {
        //////////////////////////
        // SERVER INFOS
        //////////////////////////
        ...
        let server_sig_pk_recv =
            send_connect_msg(&mut server_msl, &mut client_msl, connect_msg_custom_data)?;
        ...
        send_ack_msg(&mut client_msl, &mut server_msl, ack_msg_custom_data)?;

        //////////////////////////
        // CLIENT USER MSG
        //////////////////////////

        send_user_msg(&mut client_msl, &mut server_msl, user_msg_data.clone())?;

        //////////////////////////
        // SERVER USER MSG
        //////////////////////////

        send_user_msg(&mut server_msl, &mut client_msl, user_msg_data)?;
